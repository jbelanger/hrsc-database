...
CREATE   FUNCTION [HRSC_APP].[GetHomeClassification]
(@ReqID bigint, @bitEnglish bit)
RETURNS nvarchar(MAX)
WITH EXEC AS CALLER
AS
BEGIN
declare @HomeClassification nvarchar(MAX), @PosID bigint, @ClassGroupID bigint, @ClassSubGroupID bigint, @ClassLevelID bigint, @SubGroupCode Nvarchar(10);
