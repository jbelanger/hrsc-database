...
CREATE   FUNCTION [HRSC_APP].[GetEmployeePRI]
(@ReqID bigint)
RETURNS nvarchar(MAX)
WITH EXEC AS CALLER
AS
BEGIN
declare @empPRI nvarchar(9), @SepID bigint, @PosID bigint, @CoiID bigint, @ELSID bigint;
    ...
    if NOT @SepID is null
      begin
        set @empPRI = (SELECT RC.PRI From [HRSC].[HR_REQUEST_CLIENT] RC
