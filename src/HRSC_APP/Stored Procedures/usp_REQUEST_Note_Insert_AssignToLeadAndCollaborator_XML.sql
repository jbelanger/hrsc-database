...
CREATE PROCEDURE [HRSC_APP].[usp_REQUEST_Note_Insert_AssignToLeadAndCollaborator_XML]
...
SELECT    x.y.value( 'HrInterventionID[1]', 'bigint' ) AS REQUEST_INTERVENTION_ID,
