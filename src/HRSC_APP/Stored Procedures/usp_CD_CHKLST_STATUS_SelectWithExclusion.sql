...
create PROCEDURE [HRSC_APP].[usp_CD_CHKLST_STATUS_SelectWithExclusion]
WITH EXEC AS CALLER
AS
------------------------------------------------------
-- usp_CD_CHKLST_STATUS_SelectWithExclusion
-- Yves Robichaud  2013-06-17
------------------------------------------------------
...
WHERE CHKLST_STATUS_CODE not in ('YES','NO','UPDAT')
