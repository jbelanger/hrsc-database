...
CREATE   PROCEDURE [HRSC_APP].[usp_CD_EmailTemplateType_SelectAll]
WITH EXEC AS CALLER
AS
------------------------------------------------------
-- CD_EmailTemplateType_SelectAll 
-- Retreives all active Email Template Type (Active and inactive) 
