...
@pUserGuid nvarchar(50), @pGivenName nvarchar(30), @pSurname nvarchar(64), @pPRI nvarchar(9), @pEmailAddress nvarchar(240), @pWorkPhone nvarchar(25), @pHomePhone nvarchar(25), @pCellPhone nvarchar(25), @pTermOfUse bit, @pActiveInd bit, @pExpiryDate datetime, @pDisplayName nvarchar(120),
@pRcCode varchar(10),
