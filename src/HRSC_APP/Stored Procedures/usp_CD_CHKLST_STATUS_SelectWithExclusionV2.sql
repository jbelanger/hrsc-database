...
CREATE PROCEDURE [HRSC_APP].[usp_CD_CHKLST_STATUS_SelectWithExclusionV2]
WITH EXEC AS CALLER
AS
------------------------------------------------------
-- usp_CD_CHKLST_STATUS_SelectWithExclusionV2
-- Tony Paradis  2014-10-31
------------------------------------------------------
...
WHERE CHKLST_STATUS_CODE in ('RECOV','NONAP')
