...
USING (VALUES
 ...
 ,(2,N'LWOTP',N'On leave without Pay',N'En cong? non-pay?',N'On leave without Pay',N'En cong? non-pay?',NULL,N'System',NULL,'2018-06-13T07:21:20.850',NULL,'2018-06-13T07:21:20.850')
 ,(3,N'LWOP',N'LWOP requested to accept this appointment',N'CNP demand? afin d?accepter cette nomination',N'LWOP requested to accept this appointment',N'CNP demand? afin d?accepter cette nomination',NULL,N'System',NULL,'2018-06-13T07:21:20.850',NULL,'2018-06-13T07:21:20.850')
...
IF @mergeError1701581100 != 0
 BEGIN
 PRINT 'ERROR OCCURRED IN MERGE FOR [HRSC].[CD_PAY_STATUS]. Rows affected: ' + CAST(@mergeCount1701581100 AS VARCHAR(100)); -- SQL should always return zero rows affected
 END
ELSE
 BEGIN
 PRINT '[HRSC].[CD_PAY_STATUS] rows affected by MERGE: ' + CAST(COALESCE(@mergeCount1701581100,0) AS VARCHAR(100)) + ' (Inserted: ' + CAST(COALESCE(@mergeCountIns1701581100,0) AS VARCHAR(100)) + '; Updated: ' + CAST(COALESCE(@mergeCountUpd1701581100,0) AS VARCHAR(100)) + '; Deleted: ' + CAST(COALESCE(@mergeCountDel1701581100,0) AS VARCHAR(100)) + ')' ;
 END
