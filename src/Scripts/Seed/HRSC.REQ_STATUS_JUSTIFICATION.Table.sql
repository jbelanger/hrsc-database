...
DECLARE @mergeOutput1177771253 TABLE ( [DMLAction] VARCHAR(6) );
...
USING (VALUES
 ...
 ,(98,98,38,NULL,NULL,N'HRSC 4.13','2022-12-20T09:00:00',N'HRSC 4.13','2022-12-20T09:00:00')
 ,(99,99,38,NULL,NULL,N'HRSC 4.13','2022-12-20T09:00:00',N'HRSC 4.13','2022-12-20T09:00:00')
 ,(100,100,28,NULL,'2023-10-05T18:17:42.070',N'Robichaud, Martin M [NC]','2023-09-30T16:08:15.113',N'Robichaud, Martin M [NC]','2023-10-05T18:17:42.070')
 ,(101,100,28,NULL,'2024-01-25T10:09:23.980',N'Robichaud, Martin M [NC]','2023-10-05T18:17:42.070',N'Girouard, Francois F [NC]','2024-01-25T10:09:23.980')
 ,(102,100,28,NULL,NULL,N'Girouard, Francois F [NC]','2024-01-25T10:09:23.980',NULL,NULL)
...
OUTPUT $action INTO @mergeOutput1177771253;

DECLARE @mergeError1177771253 int,
@mergeCount1177771253 int,
@mergeCountIns1177771253 int,
@mergeCountUpd1177771253 int,
@mergeCountDel1177771253 int
SELECT @mergeError1177771253 = @@ERROR
SELECT @mergeCount1177771253 = COUNT(1), @mergeCountIns1177771253 = SUM(IIF([DMLAction] = 'INSERT', 1, 0)), @mergeCountUpd1177771253 = SUM(IIF([DMLAction] = 'UPDATE', 1, 0)), @mergeCountDel1177771253 = SUM (IIF([DMLAction] = 'DELETE', 1, 0)) FROM @mergeOutput1177771253
IF @mergeError1177771253 != 0
 BEGIN
 PRINT 'ERROR OCCURRED IN MERGE FOR [HRSC].[REQ_STATUS_JUSTIFICATION]. Rows affected: ' + CAST(@mergeCount1177771253 AS VARCHAR(100)); -- SQL should always return zero rows affected
 END
ELSE
 BEGIN
 PRINT '[HRSC].[REQ_STATUS_JUSTIFICATION] rows affected by MERGE: ' + CAST(COALESCE(@mergeCount1177771253,0) AS VARCHAR(100)) + ' (Inserted: ' + CAST(COALESCE(@mergeCountIns1177771253,0) AS VARCHAR(100)) + '; Updated: ' + CAST(COALESCE(@mergeCountUpd1177771253,0) AS VARCHAR(100)) + '; Deleted: ' + CAST(COALESCE(@mergeCountDel1177771253,0) AS VARCHAR(100)) + ')' ;
 END
