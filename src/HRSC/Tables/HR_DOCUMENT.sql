CREATE TABLE [HRSC].[HR_DOCUMENT] (
    ...
    CONSTRAINT [HRDCMNT_HRRQSTINTERV_FK] FOREIGN KEY ([HR_REQUEST_INTERVENTION_ID]) REFERENCES [HRSC].[HR_REQUEST_INTERVENTION] ([HR_REQUEST_INTERVENTION_ID])
);
...
GO
CREATE NONCLUSTERED INDEX [HRDCMNT_HRRQSTINTERV_FK_I]
    ON [HRSC].[HR_DOCUMENT]([HR_REQUEST_INTERVENTION_ID] ASC) WITH (FILLFACTOR = 80);
