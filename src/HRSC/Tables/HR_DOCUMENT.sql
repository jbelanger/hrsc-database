CREATE TABLE [HRSC].[HR_DOCUMENT] (
    ...
    CONSTRAINT [HRDCMNT_BC_FK] FOREIGN KEY ([CREATED_BY_BC_ID]) REFERENCES [HRSC].[CD_BUSINESS_CENTER] ([BUSINESS_CENTER_ID])
);
...
GO
CREATE NONCLUSTERED INDEX [HRDCMNT_BC_FK_I]
    ON [HRSC].[HR_DOCUMENT]([CREATED_BY_BC_ID] ASC) WITH (FILLFACTOR = 80);
