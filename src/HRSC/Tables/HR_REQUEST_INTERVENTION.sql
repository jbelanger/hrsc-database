...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_FK_SARG]
    ON [HRSC].[HR_REQUEST_INTERVENTION]([HR_REQUEST_ID] ASC, [BUSINESS_CENTER_ID] ASC, [HR_REQUEST_INTERVENTION_ID] ASC) WITH (FILLFACTOR = 95);


GO
CREATE NONCLUSTERED INDEX [HRRQTINT_BSNSCNTR_RQSTSTS_ID]
    ON [HRSC].[HR_REQUEST_INTERVENTION]([BUSINESS_CENTER_ID] ASC, [REQUEST_STATUS_ID] ASC)
    INCLUDE([HR_REQUEST_INTERVENTION_ID], [HR_REQUEST_ID]) WITH (FILLFACTOR = 95);
