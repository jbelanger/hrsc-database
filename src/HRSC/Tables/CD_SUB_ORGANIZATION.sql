CREATE TABLE [HRSC].[CD_SUB_ORGANIZATION] (
    ...
    [FORCED_REGION_ID]         BIGINT          NULL,
    [GD_ACCOUNT_EMAIL]         NVARCHAR (250)  NULL,
    ...
    CONSTRAINT [SBORGNZ_RGN_FK] FOREIGN KEY ([FORCED_REGION_ID]) REFERENCES [HRSC].[CD_REGION] ([REGION_ID]),
...
GO
CREATE NONCLUSTERED INDEX [SBORGNZ_RGN_FK_I]
    ON [HRSC].[CD_SUB_ORGANIZATION]([FORCED_REGION_ID] ASC) WITH (FILLFACTOR = 80);
